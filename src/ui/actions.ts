import { ActionWithParam, Action, Point } from 'src/app/types';

export const displayContextMenu: ActionWithParam<Point> = ({ state }, position) => {
    state.ui.contextMenu.position = position;
